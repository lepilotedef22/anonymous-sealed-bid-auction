...
from src.utils.crypto import encrypt, decrypt, sign, verify, concatenate, parse
...
class CryptoTest(TestCase):
    ...
    def test_concatenate(self):
        """
        Tests the concatenation of bytes strings.
        """
        concat = concatenate(b'a', b'b')
        self.assertEqual(concat, b'a - b')

    def test_parse(self):
        """
        Tests the parsing of a bytes string.
        """
        parsed = parse(b'a - b - c')
        self.assertEqual(parsed, (b'a', b'b', b'c'))
